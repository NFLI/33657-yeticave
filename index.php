            ...
            <?php foreach ($product_info as $key => $value): ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?php print($value['image_url']);?>" width="350" height="260" alt="Сноуборд">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?php print($value['category']);?></span>
                        <h3 class="lot__title"><a class="text-link" href="lot.html"><?php print($value['name']);?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?php print(showPrice($value['price']));?><b class="rub">р</b></span>
                            </div>
    ...
    <footer class="main-footer">
        <nav class="nav">
            ...
            <?php foreach ($categories as $item): ?>
                <li class="nav__item">
                    <a href="all-lots.html"><?php print($item);?></a>
                </li>
            <?php endforeach;  ?>
                <!-- <li class="nav__item">
